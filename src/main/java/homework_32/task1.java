...
public class task1 {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        MenuItem dish1 = new Dish(3, "Бургер с сыром", "Описание1");
        MenuItem dish2 = new Dish(3, "Цезарь", "Описание2");
        MenuItem dish3 = new Dish(2, "Суп сырный", "Описание3");
        MenuItem dish4 = new Dish(3, "Мясо по-французски", "Описание4");
        MenuItem dish5 = new Dish(4, "Пельмени", "Описание5");
        MenuItem drink1 = new Drink(1, "Кола", "Описание6", 0, DrinkTypeEnum.GREEN_TEA);
        MenuItem drink2 = new Drink(4, "Вино красное", "Описание7", 0.15, DrinkTypeEnum.WINE);
        MenuItem drink3 = new Drink(9, "Вода обычная", "Описание8", 0, DrinkTypeEnum.WATER);
        ...
        Address a =new Address("moscow", 32, "koshkina", 32, 'a', 4);
        Customer c = new Customer("anton", "alekseev", 20, a);
        ...
        table.getOrder(3).removeAll("Вода питьевая");
        table.getOrder(3).print();
    }
}